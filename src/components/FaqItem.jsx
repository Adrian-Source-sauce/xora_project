...
import PropTypes from "prop-types"; // Tambahkan import untuk PropTypes
  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      >
        ...
        <div className={clsx('faq-icon flex size-12 items-center justify-center border-s2 shadow-400 rounded-full border-2 transition-all duration-500 group-hover:border-s4', active && 'before:bg-p1 after:rotate-0 after:bg-p1')}>
